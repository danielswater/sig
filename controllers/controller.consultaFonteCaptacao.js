 ...
 */
smartSig.registerCtrl('consultaFonteCaptacao', function($scope, $http, $location, $filter, filterFilter, $timeout, Permissao, $routeParams) {
    ...
    $scope.editCadastro = function(id){
      $location.path('/forms/formCadastroFonteCaptacao/1/'+id)
    }      
