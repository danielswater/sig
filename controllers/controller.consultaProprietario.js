smartSig.registerCtrl('consultaProprietario', function($scope, $http, $location, $filter, filterFilter, Mensagem, $timeout, Permissao, $routeParams) {
	...
	$scope.editCadastro = function(id){
		$location.path('/forms/formCadastroProprietario/1/'+id)
	}      
