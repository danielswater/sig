smartSig.registerCtrl('consultaConvidado', function($scope, $http, $location, $filter, filterFilter, Mensagem, $timeout, Permissao, $routeParams) {
    ...
    $http.get('api/index.php/consultapessoa/7').    
      success(function(data, status, headers, config) {                                 
        if (data.pessoa[0].error == 0) {
    ...
    $scope.editCadastro = function(id){
      $location.path('/forms/formCadastroPF/5/'+id)
    }      
