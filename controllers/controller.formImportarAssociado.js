  ...
  Versão: 1.0
 */
smartSig.registerCtrl("formImportarAssociado", function($scope, $location, $http, $routeParams, Mensagem, $timeout, Permissao, $modal){
	...
	$scope.getLerPasta = function(){
		$http.get('api/index.php/lerpasta/associados').    
	...
	$scope.importarAssociados = function() {  
		...
		for(var a=2; a < $scope.importar.total; a=a+pct){
			...
			$http.post('api/index.php/importarpessoa/', $scope.json, 
