smartSig.registerCtrl("formCadastroFuncionario", function($scope, $http, $routeParams, Mensagem, $timeout, $rootScope, $location, $modal, Permissao){
...
.error(function(data, status, headers, config) {
	...
	$scope.cadastrarEnderecoPessoa = function(objeto,idTipoEndereco) {
		...
		if ($('#cadastroFuncionario-Endereco-form').valid()) {
	...
	$scope.cadastrarContribuicaoPessoa = function(objeto) {
		...
		if ($('#cadastroFuncionario-Contribuicao-form').valid()) {
...
.error(function(data, status) {
	...
	$scope.novoCadastro = function(){
		$location.path('/forms/formCadastroFuncionario/');
	}
	// /BUSCA PESSOA
