app.registerCtrl('consultaAvaliacoesNotas', function($scope, $location, $http, $routeParams, toaster, $window) {
	...
	$scope.cursoId = '';
	$scope.$parent.filtroAvancado.busca = {};
	...
	$scope.redirectPage = function(fase, disciplina, professor, turma){
		fase = $scope.id_fase;
		$location.path("consultaAvaliacoes/"+fase+'/'+disciplina+'/'+professor+'/'+turma+'/'+$scope.cursoId);
	}
