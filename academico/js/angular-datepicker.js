...
(function withAngular(angular) {
  ...
  angular.module('720kb.datepicker', [])
		.directive('calendario', ['$window', '$compile', '$locale', '$filter', '$interpolate', function manageDirective($window, $compile, $locale, $filter, $interpolate) {
    ...
    return {
      ...
      'link': function linkingFunction($scope, element, attr) {
        ...
        var selector = attr.selector
          ...
          , theCalendar
          , defaultPrevButton = '<b class="datepicker-default-button"><i style="color: #fff" class="icon-circle-arrow-left"></i></b>'
          , defaultNextButton = '<b class="datepicker-default-button"><i style="color: #fff" class="icon-circle-arrow-right"></i></b>'
