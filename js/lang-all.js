(function(e) {
    ...
    function() {
        ...
        var r = "nolla yksi kaksi kolme neljÃ¤ viisi kuusi seitsemÃ¤n kahdeksan yhdeksÃ¤n".split(" "),
            i = ["nolla", "yhden", "kahden", "kolmen", "neljÃ¤n", "viiden", "kuuden", r[7], r[8], r[9]];
    ...
    function() {
        ...
        var d = {
            ...
            l = "sekmadienis_pirmadienis_antradienis_treÄiadienis_ketvirtadienis_penktadienis_Å¡eÅ¡tadienis".split("_");
    ...
    function() {
        (t.defineLocale || t.lang).call(t, "pt-br", {
            ...
            calendar: {
                ...
                lastDay: "[Ontem às] LT",
                lastWeek: function() {
                    return 0 === this.day() || 6 === this.day() ? "[Ãšltimo] dddd [às] LT" : "[Ãšltima] dddd [às] LT"
                },
                sameElse: "L"
            },
            relativeTime: {
    ...
    function() {
        ...
        function s(e, t) {
            var a = {
                ...
                n = /\[ ?[Ð’Ð²] ?(?:Ð¿Ñ€Ð¾ÑˆÐ»ÑƒÑŽ|ÑÐ»ÐµÐ´ÑƒÑŽÑ‰ÑƒÑŽ)? ?\] ?dddd/.test(t) ? "accusative" : "nominative";
            return a[n][e.day()]
    ...
    }(), (t.locale || t.lang).call(t, "pt-br"), e.fullCalendar.lang("pt-br"), e.datepicker && e.datepicker.setDefaults(e.datepicker.regional[""])
});