...
function toast(a, b, c) {
    ...
    if (c = c || "", 0 == $("#toast-container").length) {
        var e = $("<div></div>").attr("id", "toast-container");
        $("body").append(e)
    }
    var e = $("#toast-container"),
        f = d(a);
    e.append(f), f.css({
        top: parseFloat(f.css("top")) + 35 + "px",
        opacity: 0
    }), f.velocity({
        top: "0px",
        opacity: 1
    ...
    var g = b,
        h = setInterval(function() {
            0 === f.parent().length && window.clearInterval(h), f.hasClass("panning") || (g -= 100), 0 >= g && (f.velocity({
                opacity: 0,
                marginTop: "-40px"
            }, {
                duration: 375,
...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
                            ...
                            for (var I in s) {
                                ...
                                if (g(h).isSVG || v.Names.prefixCheck(P)[1] !== !1 || v.Normalizations.registered[P] !== d) {
                                    ...
                                    if (R = n(I, O), O = R[0], T = R[1], R = n(I, M), M = R[0].replace(/^([+-\/*])=/, function(a, b) {
                                            return U = b, ""
                                        }), S = R[1], O = parseFloat(O) || 0, M = parseFloat(M) || 0, "%" === S && (/^(fontSize|lineHeight)$/.test(I) ? (M /= 100, S = "em") : /^scale/.test(I) ? (M /= 100, S = "") : /(Red|Green|Blue)$/i.test(I) && (M = M / 100 * 255, S = "")), 
                                        /[\/*]/.test(U)) S = T;
                                    else if (T !== S && 0 !== O)
                                        if (0 === M) S = T;
                                        else {
    ...
    function(a) {
        a.fn.collapsible = function(b) {
            ...
            b = a.extend(c, b);
            var d = (a(this), a(this).find(".collapsible-header"));
            d.each(c.accordion ? function() {
                a(this).click(function() {
                    a(this).parent().toggleClass("active"), a(this).parent().hasClass("active") ? a(this).siblings(".collapsible-body").stop(!0, !1).slideDown({
                        duration: 350,
                        easing: "easeOutQuart",
                        queue: !1
                    }) : a(this).siblings(".collapsible-body").stop(!0, !1).slideUp({
                        duration: 350,
                        easing: "easeOutQuart",
                        queue: !1
                    }), d.not(a(this)).parent().removeClass("active"), d.not(a(this)).parent().children(".collapsible-body").stop(!0, !1).slideUp({
                        duration: 350,
                        easing: "easeOutQuart",
                        queue: !1
                    })
    ...
    function(a) {
        a.fn.dropdown = function(b) {
            ...
            b = a.extend(c, b), this.each(function() {
                var b = a(this),
                    d = a("#" + b.attr("data-activates"));
                if (d.hide(0), c.hover) b.on("mouseover", function() {
                    d.css("width", b.outerWidth()), d.css("top", b.offset().top), d.css("left", b.offset().left), d.show({
                        duration: 200,
                        easing: "easeOutCubic"
                    })
                    ...
                    b.click(function(c) {
                        c.preventDefault(), c.stopPropagation(), d.css("width", b.outerWidth()), d.css("top", b.offset().top), d.css("left", b.offset().left), d.show({
                            duration: 200,
                            easing: "easeOutCubic"
                        }), a(document).bind("click." + d.attr("id"), function(c) {
                            d.is(c.target) || b.is(c.target) || (d.hide({
                                duration: 175,
                                easing: "easeOutCubic"
                            }), a(document).unbind("click." + d.attr("id")))
                        })
                    })
                }
                a(document).on("resize", function() {
                    b.is(":visible") && (d.css("top", b.offset().top), d.css("left", b.offset().left))
                })
            })
        }
    }(jQuery),
    function(a) {
        a.fn.extend({
            openModal: function(b) {
                ...
                b = a.extend(e, b), a("#lean-overlay").click(function() {
                    a(c).closeModal(b)
    ...
    function(a) {
        a.fn.materialbox = function() {
            return this.each(function() {
                function b() {
                    var b = g.parent(".material-placeholder").attr("z-index");
                    b || (b = 0), c = !1, a("#materialbox-overlay").fadeOut(f, function() {
                        a(this).remove(), g.css("z-index", b)
                    }), g.animate({
                        width: i
                    }, {
                        duration: f,
                        ...
                        queue: !1,
                        easing: "easeOutQuad"
                    }), g.css("will-change", ""), g.removeClass("active")
                }
                var c = !1,
                    d = !0,
                    e = 275,
                ...
                g.wrap(h), g.on("click", function() {
                    ...
                    if (c || d === !1) return b(), !1;
                    g.addClass("active"), i = g.width(), j = g.height(), g.parent(".material-placeholder").css("width", g.innerWidth()).css("height", j).css("position", "relative").css("top", 0).css("left", 0).css("z-index", g.attr("z-indez")), g.css("position", "absolute");
                    var k = a("<div></div>");
                    k.attr("id", "materialbox-overlay").css("width", a(document).width() + 100).css("height", a(document).height() + 100).css("top", 0).css("left", 0).css("opacity", 0).css("will-change", "opacity").click(function() {
                        b()
                    }), a("body").append(k), k.animate({
                        opacity: 1
                    }, {
                        duration: e,
                        queue: !1,
                    ...
                    var l = 0,
                        ...
                        o = 0,
                        p = 0;
                    m > n ? (l = j / i, o = .9 * f, p = .9 * f * l) : (l = i / j, o = .9 * h * l, p = .9 * h), g.css("left", 0).css("top", 0).css("z-index", 1e3).css("will-change", "left, top").animate({
                        height: p,
                        width: o
                    }, {
                        duration: e,
                        ...
                        left: a(document).scrollLeft() + f / 2 - g.parent(".material-placeholder").offset().left - o / 2
                    }, {
                        duration: e,
                        queue: !1,
                        easing: "easeOutQuad"
                    }).animate({
                        top: a(document).scrollTop() + h / 2 - g.parent(".material-placeholder").offset().top - p / 2
                    }, {
                        duration: e,
                        queue: !1,
                        easing: "easeOutQuad",
        ...
        a.fn.tabs = function() {
            return this.each(function() {
                ...
                var d, e, f = b.find("li.tab a"),
                    ...
                    i = 0;
                d = a(f.filter('[href="' + location.hash + '"]')[0] || f[0]), d.addClass("active"), i = f.index(d), 0 > i && (i = 0), e = a(d[0].hash), b.append('<div class="indicator"></div>');
    ...
    function(a) {
        ...
        a.fn.tooltip = function(e) {
            ...
            return e = a.extend(g, e), this.each(function() {
                var e = a(this),
                    h = a("<div></div");
                h.addClass("material-tooltip").text(e.attr("title")), h.appendTo(a("body"));
                var i = a("<div></div").addClass("backdrop");
                i.appendTo(h), i.css({
                    top: 0,
                    left: 0,
                    marginLeft: h.outerWidth() / 2 - i.width() / 2
                }), a(this).hover(function(a) {
                    a.stopPropagation(), b = 0, d = setInterval(function() {
                        b += 50, b >= g.delay && 0 == c && (c = !0, h.css({
                            display: "block"
                        }), h.css({
                            top: e.offset().top + e.outerHeight() + f,
                            left: e.offset().left + e.outerWidth() / 2 - h.outerWidth() / 2
                        }), scale_factor = h.width() / 8, 8 > scale_factor && (scale_factor = 8), h.velocity({
                            opacity: 1,
                            marginTop: "+10px"
                        }, {
                            duration: 350,
        ...
        var f = f || {},
            ...
            h = {
                ...
                show: function(a) {
                    ...
                    "touches" in a && (g = a.touches[0].pageY - f.top, i = a.touches[0].pageX - f.left), c.setAttribute("data-hold", Date.now()), c.setAttribute("data-scale", j), c.setAttribute("data-x", i), c.setAttribute("data-y", g);
                    var k = {
                        top: g + "px",
                        left: i + "px"
                    };
                    c.className = c.className + " waves-notransition", c.setAttribute("style", e(k)), c.className = c.className.replace("waves-notransition", ""), k["-webkit-transform"] = j, k["-moz-transform"] = j, k["-ms-transform"] = j, k["-o-transform"] = j, k.transform = j, k.opacity = "1", k["-webkit-transition-duration"] = h.duration + "ms", k["-moz-transition-duration"] = h.duration + "ms", k["-o-transition-duration"] = h.duration + "ms", k["transition-duration"] = h.duration + "ms", c.setAttribute("style", e(k))
                },
                hide: function() {
                ...
                a("nothing").hammer({
                    ...
                    if ("touch" === d.gesture.pointerType) {
                        ...
                        if (h) {
                            ...
                            f > b.menuWidth ? f = b.menuWidth : 0 > f ? f = 0 : f < b.menuWidth / 2 ? i = !1 : f >= b.menuWidth / 2 && (i = !0), g.velocity({
                                left: -1 * b.menuWidth + f
                            }, {
                                duration: 50,
                                queue: !1,
                                easing: "easeOutQuad"
                        ...
                        } else i ? d.gesture.center.x > b.menuWidth - b.activationWidth && 2 === e && (h = !0) : d.gesture.center.x < b.activationWidth && 4 === e && (h = !0)
                    }
                }).bind("panend", function(b) {
                    "touch" === b.gesture.pointerType && (h = !1, i ? (g.velocity({
                        left: 0
                    }, {
                        duration: 300,
                        queue: !1,
                    ...
                    if (g.hasClass("active")) i = !1, h = !1, c();
                    else {
                        e(), g.velocity({
                            left: 0
                        }, {
                        ...
                        var b = a('<div id="sidenav-overlay"></div>');
                        b.css("opacity", 0).click(function() {
                            i = !1, h = !1, c(), b.animate({
                                opacity: 0
                            }, {
                                duration: 300,
    ...
    function(a) {
        a(document).ready(function() {
            ...
            if (a(b).each(function() {
                    0 !== a(this).val().length && a(this).siblings("label").addClass("active")
                }), a(document).on("focus", b, function() {
                    a(this).siblings("label").addClass("active")
                }), a(document).on("blur", b, function() {
                    0 === a(this).val().length && a(this).siblings("label").removeClass("active")
            ...
            a("body").on("keyup keydown", e, function() {
                d = a(this).val(), d = d.replace(/\n/g, "<br>"), console.log(d), c.html(d + "<br>"), a(this).css("height", c.height())
            });
            ...
            a(document).on("mousedown", h, function(b) {
                ...
                a(this).each(function() {
                    if ($select = a(this), $select.hasClass("disabled") || $select.hasClass("initialized")) return !1;
                    var b = i(),
                        c = a('<div class="select-wrapper"></div>'),
                        d = a('<ul id="select-options-' + b + '" class="dropdown-content"></ul>'),
                        e = $select.children("option"),
                        f = e.first();
                    e.each(function() {
                        d.append(a("<li><span>" + a(this).html() + "</span></li>"))
                    }), d.find("li").each(function(b) {
                        var c = $select;
                        a(this).click(function() {
                            c.find("option").eq(b + 1).prop("selected", !0), c.prev("span.select-dropdown").html(a(this).text())
                        })
                    }), $select.wrap(c);
                    var g = a('<span class="select-dropdown" data-activates="select-options-' + b + '">' + f.html() + "</span>");
                    $select.before(g), a("body").append(d), g.dropdown({
                        hover: !1
    ...
    function(a) {
        a.fn.slider = function(b) {
            ...
            return b = a.extend(c, b), this.each(function() {
                ...
                e ? e.show() : (console.log("false"), h.first().addClass("active").velocity({
                    opacity: 1
                }, {
                    duration: b.transition,
                    queue: !1,
    ...
    function(a) {
        a(document).ready(function() {
            a(document).on("click.card", ".card", function(b) {
                a(this).find(".card-reveal").length && (console.log("card reveal"), a(b.target).is(a(".card-reveal span.card-title")) || a(b.target).is(a(".card-reveal span.card-title i")) ? a(this).find(".card-reveal").velocity({
                    translateY: 0
                }, {
                    duration: 300,
                    queue: !1,
        ...
        function b(f, g, i, l) {
            ...
            function n() {
                w.data(g, y).addClass(v.input).attr("tabindex", -1).val(w.data("value") ? y.get("select", u.format) : f.value), u.editable || w.on("focus." + t.id + " click." + t.id, function(a) {
                    ...
                    expanded: !1,
                    readonly: !1,
                    owns: f.id + "_root" + (y._hidden ? " " + y._hidden.id : "")
                })
            }
            ...
            function o() {
                y.$root.on({
                    ...
                    "mousedown click": function(b) {
                        var c = b.target;
                        c != y.$root.children()[0] && (b.stopPropagation(), "mousedown" != b.type || a(c).is(":input") || "OPTION" == c.nodeName || (b.preventDefault(), y.$root[0].focus()))
                    }
                }).on({
                    focus: function() {
                        w.addClass(v.target)
                    ...
                    e = e && (e.type || e.href), (d || e && !a.contains(y.$root[0], e)) && y.$root[0].focus(), !d && c.nav ? y.set("highlight", y.component.item.highlight, {
                        nav: c.nav
                    }) : !d && "pick" in c ? y.set("select", c.pick).close(!0) : c.clear ? y.clear().close(!0) : c.close && y.close(!0)
                }), e(y.$root[0], "hidden", !0)
            }
    ...
    function(a) {
        ...
        var d = 7,
            ...
            h = 60 * g * 1e3,
            i = function(a, b) {
                return a.getDate() === b.getUTCDate() && a.getMonth() === b.getUTCMonth() && a.getFullYear() === b.getUTCFullYear()
            },
            j = function(a, b) {
        ...
        c.prototype.set = function(a, b, c) {
            ...
            return d = d || {}, c = void 0 === c ? a : c, c == -1 / 0 || 1 / 0 == c ? {
                year: c,
                month: c,
                date: c,
                day: c,
                obj: c,
                pick: c
            } : (c === !0 ? (c = new Date, d.rel && c.setDate(c.getDate() + d.rel)) : b.isPlainObject(c) && f.isInteger(c.pick) && (c = [c.year, c.month, c.date]), Array.isArray(c) && (c = new Date(c[0], c[1], c[2])), c = new Date(c), c.setHours(-g / 60, -g % 60, 0, 0), c = new Date(c.getTime() + h), {
                year: c.getFullYear(),
                month: c.getMonth(),
                date: c.getDate(),
                day: c.getDay(),
            ...
            var e, f, g, h, i = b.isArray(c),
                ...
                l = 100;
            if (i || j) {
                for (j ? (f = c.year, g = c.month, h = c.date) : (f = +c[0], g = +c[1], h = +c[2]), d && d.nav && k && k.month !== g && (f = k.year, g = k.month), e = new Date(f, g + (d && d.nav ? d.nav : 0), 1), f = e.getFullYear(), g = e.getMonth(); l && new Date(f, g, h).getMonth() !== g;)
                    if (h -= 1, l -= 1, !l) throw "Fell into an infinite loop while navigating to " + new Date(f, g, h) + ".";
                c = [f, g, h]
            }
            return c
        }, c.prototype.measure = function(a, b, c) {
            c = c || {};
            var d = this;
            return b ? "string" == typeof b ? b = d.parse(a, b) : f.isInteger(b) && (c.rel = b, b = !0) : b = "min" == a ? -1 / 0 : 1 / 0, b
            ...
            if ((!d || !d.nav) && (!m && j.disabled(c) || m && j.disabled(c) && (p || e || g) || !m && (c.pick <= n.pick || c.pick >= o.pick)))
                for (m && !p && (!g && l > 0 || !e && 0 > l) && (l *= -1); q && j.disabled(c);) {
                    if (q -= 1, !q) throw "Fell into an infinite loop while validating " + c.obj + ".";
                    if (Math.abs(l) > 1 && (c.month < k.month || c.month > k.month) && (c = k, l = l > 0 ? 1 : -1), c.pick <= n.pick ? (h = !0, l = 1, c = j.create([n.year, n.month, n.date + (c.pick === n.pick ? 0 : -1)])) : c.pick >= o.pick && (i = !0, l = -1, c = j.create([o.year, o.month, o.date + (c.pick === o.pick ? 0 : 1)])), h && i) break;
            ...
            var b = this,
                ...
                s = function(a) {
                    return f.node("div", " ", c.klass["nav" + (a ? "Next" : "Prev")] + (a && n.year >= q.year && n.month >= q.month || !a && n.year <= p.year && n.month <= p.month ? " " + c.klass.navDisabled : ""), "data-nav=" + (a || -1) + " " + f.ariaAttr({
                        role: "button",
                ...
                t = function(d) {
                    ...
                    return "short_months" == d && (e = c.monthsShort), c.selectMonths ? f.node("select", f.group({
                        ...
                        node: "option",
                        item: function(a) {
                            return [e[a], 0, "value=" + a + (n.month == a ? " selected" : "") + (n.year == p.year && a < p.month || n.year == q.year && a > q.month ? " disabled" : "")]
                        }
                    }), c.klass.selectMonth, (a ? "" : "disabled") + " " + f.ariaAttr({
                        controls: b.$node[0].id + "_table"
                    }) + ' title="' + c.labelMonthSelect + '"') : "short_months" == d ? f.node("div", e[n.month]) : f.node("div", e[n.month], c.klass.month)
                },
                u = function(d) {
                    var e = n.year,
            ...
            return createDayLabel = function() {
                return null != l ? f.node("div", l.date) : f.node("div", h.date)
            }, createWeekdayLabel = function() {
                var a;
                a = null != l ? l.day : h.day;
                var b = c.weekdaysFull[a];
                return b
            }, f.node("div", f.node("div", createWeekdayLabel(), "picker__weekday-display") + f.node("div", t("short_months"), c.klass.month_display) + f.node("div", createDayLabel(), c.klass.day_display) + f.node("div", u("raw"), c.klass.year_display), c.klass.date_display) + f.node("div", f.node("div", (c.selectYears ? u() + t() : t() + u()) + s() + s(1), c.klass.header) + f.node("table", r + f.node("tbody", f.group({
                min: 0,
                max: e - 1,
                i: 1,
                node: "tr",
                item: function(a) {
                    var e = c.firstDay && 0 === b.create([n.year, n.month, 1]).day ? -7 : 0;
                    return [f.group({
                        min: d * a - n.day + e + 1,
                        max: function() {
                            return this.min + d - 1
                        ...
                        node: "td",
                        item: function(a) {
                            a = b.create([n.year, n.month, a + (c.firstDay ? 1 : 0)]);
                            var d = i(h.obj, a.obj),
                                e = l && i(l.obj, a.obj),
                                g = m && i(m.obj, a.obj),
                                r = o && b.disabled(a) || j(a, p) || k(a, q);
                            return [f.node("div", a.obj.getUTCDate(), function(b) {
                                return b.push(n.month == a.month ? c.klass.infocus : c.klass.outfocus), d && b.push(c.klass.now), e && b.push(c.klass.selected), g && b.push(c.klass.highlighted), r && b.push(c.klass.disabled), b.join(" ")
                            }([c.klass.day]), "data-pick=" + a.pick + " " + f.ariaAttr({
                                role: "gridcell",
                                selected: e && b.$node.val() === f.trigger(b.formats.toString, b, [c.format, a]) ? !0 : null,
                                activedescendant: g ? !0 : null,
                                disabled: r ? !0 : null
                            })), "", f.ariaAttr({
                                role: "presentation"
                            })]
                ...
                readonly: !0
            })), c.klass.calendar_container) + f.node("div", f.node("button", c.today, "btnmd btnmd-primary picker__today", "type=button data-pick=" + h.pick + (a && !b.disabled(h) ? "" : " disabled") + " " + f.ariaAttr({
                controls: b.$node[0].id
            })) + f.node("button", c.close, "btnmd btnmd-default picker__close", "type=button data-clear=true " + (a ? "" : " disabled") + " " + f.ariaAttr({
                controls: b.$node[0].id
            })), c.klass.footer)
