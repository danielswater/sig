/*! SmartAdmin - v1.4.0 - 2014-05-26 */ ! function(a, b, c, d) {
    function e(b, c) {
    ...
    e.prototype = {
        ...
        init: function() {
            var b = this;
            if (b._settings(), a("#" + b.objId).length || console.log("It looks like your using a class instead of an ID, dont do that!"), b.o.rtl === !0 && a("body").addClass("rtl"), a(b.o.grid).each(function() {
            ...
            if (b.widget.each(function() {
                    ...
                    c.find(".jarviswidget-ajax-placeholder").length || (c.children("widget-body").append('<div class="jarviswidget-ajax-placeholder">' + b.o.loadingLabel + "</div>"), c.data("widget-refresh") > 0 ? (b._loadAjaxFile(c, e, d), setInterval(function() {
