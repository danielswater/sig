/*! SmartAdmin - v1.4.0 - 2014-06-01 */ ! function(a) {
    a.extend(a.fn, {
        validate: function(b) {
        ...
        defaults: {
            ...
            highlight: function(b, c, d) {
                "radio" === b.type ? this.findByName(b.name).addClass(c).removeClass(d).parent().parent().addClass("state-error has-error").parent().removeClass("state-success") : a(b).addClass(c).removeClass(d).parent().parent().addClass("state-error has-error").removeClass("state-success")
                "radio" === b.type ? this.findByName(b.name).addClass(c).removeClass(d).parent().addClass("state-error has-error").parent().removeClass("state-success") : a(b).addClass(c).removeClass(d).parent().addClass("state-error has-error").removeClass("state-success")
            },
            unhighlight: function(b, c, d) {
                "radio" === b.type ? this.findByName(b.name).removeClass(c).addClass(d).parent().parent().addClass("state-success").parent().removeClass("state-error has-error") : a(b).removeClass(c).addClass(d).parent().parent().addClass("state-success").removeClass("state-error has-error")
                "radio" === b.type ? this.findByName(b.name).removeClass(c).addClass(d).parent().addClass("state-success").parent().removeClass("state-error has-error") : a(b).removeClass(c).addClass(d).parent().addClass("state-success").removeClass("state-error has-error")
            }
        },
        ...
        messages: {
            ...
            datebr: "Please enter a valid date",
            cpf: "Please enter a valid cpf",
            cnpj: "Please enter a valid cnpj",
            datetimeBR: "Please enter a valid date and hour",
            hora: "Please enter a valid hour",
            telefone: "Please enter a valid phone number",
            mobile: "Please enter a valid mobile phone",
            cep: "Please enter a valid cep",
            maxlength: a.validator.format("Por favor, não pode ultrapassar {0} characters"),
            minlength: a.validator.format("Por favor, entre com pelo menos {0} characters"),
            rangelength: a.validator.format("Please enter a value between {0} and {1} characters long"),
            range: a.validator.format("Please enter a value between {0} and {1}"),
            max: a.validator.format("Please enter a value less than or equal to {0}"),
            min: a.validator.format("Please enter a value greater than or equal to {0}"),
            time: "Please entar a valid hour"
        },
        autoCreateRanges: !1,
        prototype: {
            init: function() {
