...
$.fn.rangeCalendar = function(options) {
	...
	this.each(function(i, el) {
		...
		obj._initRangeBar = function(){
		    ...
		    $(selectedCell).append('<div class="range-bar resizable" style="width:70px;"><div class="range-bar-content"></div></div>');
		...
		obj._initMonths  = function() {	    
		    ...
		    obj.monthsObj.draggable('destroy');
		    obj.monthsObj.css('cursor','pointer');
		    ...
		    obj.calendarObj.draggable({ 
		      	...
		      	cursor: "move",
		      		...
		      		create: function () {
				  		...
				  		$(obj.calendarObj[0]).find('.cal-cell:first').addClass('start selected last')
				  		.append('<div class="cell-content"><div class="day-number"></div><div class="day "></div></div>').
				  		append('<div class="range-bar resizable ui-resizable" style="width: 70px;"><div class="range-bar-content"></div><div class="ui-resizable-handle ui-resizable-e" style="z-index: 90;"></div></div>');
