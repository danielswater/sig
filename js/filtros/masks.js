...
.directive('uiBrPhoneNumber', ['PhoneValidators', function(PhoneValidators) {
	 ...
	 */
	var phoneMask8D = new StringMask('(000) 0000-0000'),
		phoneMask9D = new StringMask('(000) 00000-0000');
		phoneMask12D = new StringMask('(000) 0000-0000 0000');
	...
	function applyPhoneMask (value) {
		...
		if(value.length <= 11){
			...
			formatedValue = phoneMask12D.apply(value);
		}else{
